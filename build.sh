...
xcodebuild -project MenuBarCompact.xcodeproj -scheme MenuBarCompact \
  -configuration "$BUILD_CONFIGURATION" -derivedDataPath build/Xcode CODE_SIGN_IDENTITY="$BUILD_SIGNING_IDENTITY" build
ditto "build/Xcode/Build/Products/$BUILD_CONFIGURATION/MenuBarCompact.app" build/MenuBarCompact.app
